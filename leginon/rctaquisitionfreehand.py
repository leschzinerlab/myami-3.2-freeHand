...
#load the db definition module 
import acquisition
#load gui 
import gui.wx.RCTAquisitionFreeHand
try:
	import openCVcaller
	NO_CV = False
except:
...
class RCTAquisitionFreeHand(acquisition.Acquisition):
	panelclass = gui.wx.RCTAquisitionFreeHand.Panel
